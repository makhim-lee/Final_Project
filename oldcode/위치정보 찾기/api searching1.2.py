...
# Usage example:
assistant = ObjectDetectionAssistant("yolov3.weights", "yolov3.cfg", "coco.names", "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")
object_list, image = assistant.detect_objects("sample2.jpg")
messages = assistant.infer_location(object_list)
